 ...
 */
router.get('/savings/summary', auth_middleware_1.authMiddleware, savingsGoalController.getMonthlySavings);
/**
 * @swagger
 * /api/savings-goals:
 *   get:
...
router.use(savingsGoalErrorHandler);
